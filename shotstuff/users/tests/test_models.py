...
class UserModelTestCase(unittest.TestCase):
    ...
    def test_upcoming_injection_times_all_within_2_weeks(self):
        ...
        inj_date_with_tz = convert_date_to_tz(
            inj_date_utc,
            self.t1.user.timezone_location
        )
        ...
        self.assertEqual(
            ...
            [
                {
                    "full_date_time": generate_friendly_date_time(inj_date_with_tz),
                    "formatted_date": inj_date_with_tz.strftime('%m/%d/%Y'),
                    "treatment": self.t1
                }
            ]
        )
